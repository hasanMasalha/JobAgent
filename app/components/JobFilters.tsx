...
const LABEL = "block text-xs font-medium text-gray-400 uppercase tracking-wide mb-1.5";

const SELECT =
  "appearance-none bg-white border border-gray-200 rounded-lg px-3 py-2 pr-8 text-sm font-medium " +
  "text-gray-700 hover:border-gray-400 focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 " +
...
const Divider = () => <div className="w-px h-8 bg-gray-200 shrink-0 self-end mb-0.5" />;
    ...
    <div className="flex flex-wrap items-end gap-3">
      ...
      <div>
        ...
        <input
          ...
          className="bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-700 placeholder:text-gray-400 w-[140px] hover:border-gray-400 focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 focus:outline-none transition-colors"
        />
      </div>
    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm px-5 py-4 mb-6">
      ...
      <div className="sm:hidden flex items-center justify-between mb-3">
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
          className="flex items-center gap-1.5 text-sm font-medium text-gray-700 border border-gray-200 rounded-lg px-3 py-1.5"
        >
