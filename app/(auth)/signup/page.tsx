...
export default function SignupPage() {
  ...
  if (done) {
    return (
      <div style={{ minHeight: "100vh", background: "#f4f5f7", display: "flex", alignItems: "center", justifyContent: "center", padding: "32px 16px" }}>
        <div style={{ width: "100%", maxWidth: 400, background: "white", borderRadius: 12, boxShadow: "0 2px 16px rgba(0,0,0,0.08)", padding: "40px 32px", textAlign: "center", boxSizing: "border-box" }}>
          <h1 style={{ fontSize: 20, fontWeight: 500, marginBottom: 8, color: "#111" }}>Check your email</h1>
  ...
  const formPanel = (
    <>
      ...
      <p style={{ fontSize: 13, color: "#6b7280", marginBottom: 24 }}>
        Sign up to get started with JobAgent
      </p>
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ marginBottom: 14 }}>
          ...
          <input
            ...
            onBlur={(e) => { e.target.style.borderColor = "#e0e0e0"; e.target.style.background = "#f5f6f8"; }}
          />
        </div>
      ...
      <p style={{ marginTop: 20, fontSize: 13, color: "#6b7280", textAlign: "center" }}>
        ...
        <Link href="/login" style={{ color: NAVY, textDecoration: "underline" }}>
          Sign in
        </Link>
      </p>
    </>
